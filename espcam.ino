...
const char* ssid = "KNSLAPTOP"; //wifi settings
...
void connect() {
  ...
  Serial.print("\nconnecting");
  if(client.connect("Cam","public","public")){
    Serial.println("\nMqtt Server connected!");
    client.publish("robot/cam/status","Connected",true,0);
    client.publish("robot/cam/IP",ipAddressString.c_str(),true,0);
  }
}
void reconnect(){
